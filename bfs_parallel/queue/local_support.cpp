...
unsigned long long INPUT_SIZE = sizeof(struct bench_args_t);

void run_benchmark(void* vargs)
{
   struct bench_args_t* args = (struct bench_args_t*)vargs;
#ifdef __BAMBU_SIM__
   m_param_alloc(0, sizeof(args->nodes));
   m_param_alloc(1, sizeof(args->edges));
   m_param_alloc(3, sizeof(args->level));
   m_param_alloc(4, sizeof(args->level_counts));
#endif
